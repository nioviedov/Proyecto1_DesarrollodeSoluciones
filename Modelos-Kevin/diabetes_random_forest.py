...
experiment = mlflow.set_experiment("diabetes-randomforest")
...
with mlflow.start_run(experiment_id=experiment.experiment_id):
    ...
    mlflow.log_param("min_samp_split", min_samples_split)
    mlflow.log_param("min_samp_leaf", min_samples_leaf)
